...
0 for unmapped reads\tabularnewline
\hline
ltf8 & number of records & number of records in the container\tabularnewline
\hline
...
reads\tabularnewline
\hline
ltf8 & number of records & the number of records in the slice\tabularnewline
\hline
...
\hline
8b d7 72 2f & integer & 796055435 & container header CRC32\tabularnewline
\hline
...
\hline
int & compressed size & the size in bytes of the compressed blob\tabularnewline
\hline
